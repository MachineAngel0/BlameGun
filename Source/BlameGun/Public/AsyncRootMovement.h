 ...
 */
UCLASS()
class BLAMEGUN_API UAsyncRootMovement : public UCancellableAsyncAction
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, DisplayName = "Apply Root Motion Constant Force with Callbacks",
		Category = "RootMovement",
		meta = (WorldContext = "WorldContext", BlueprintInternalUseOnly = "true", Keywords =
			"RootMovement RootMotion Root Motion Movement"))
